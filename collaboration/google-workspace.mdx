...
This allows Teammates to use your Google Workspace email instead of your default internal email address.

Here's how to add your new Google Workspace email to your teammate's profile:
...
<Note>
When you set your external email, Teammates will automatically prefer this address instead of their internal email for all communications.
</Note>
