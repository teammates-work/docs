...
By default, Teammates will reference their "internal email address" for recieving emails. Once they have a GMail address, you'll want to override
the internal one with your branded one. Otherwise, they won't know what their new email is (just like you would tell a new employee what their corporate email address is).
...
4. Enter your teammate's new GMail address (e.g., teammate.name@yourcompany.com)
5. Save your changes
