...
1. Visit [Slack Apps page](https://api.slack.com/apps) and click `Create New App` and select your workspace. (If you don't see your workspace, you may need to Ask your Slack Admin to give you permission or follow these steps for you.)
