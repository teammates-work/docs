...
Click "Get Started" below to view our Interactive Slack Setup Guide to see how it works:

<iframe 
  src="https://demo.arcade.software/7EttVTZpK3gR1fvgd9p9?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" 
  title="Connect a Teammate to Slack"
  className="w-full h-96 rounded-xl" allowFullScreen></iframe>
...
1. Visit [Slack Apps page](https://api.slack.com/apps) and click `Create New App` and select your workspace. (If you don't see your workspace, you may need to Ask your Slack Admin to give you permmission or follow these steps for you.)
...
1. Go back to the [Teammates app](https://app.teammates.work/teammates) and paste your token into the `Bot User OAuth Token` field and click `Save`
