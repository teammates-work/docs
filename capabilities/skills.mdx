...
- **Browse Web:** Browse the web and fill out forms
...
### Intrinsic Abilities
- **Assignment History:** Recall past work assignments and their results
...
<Info>
Intrinsic abilities are built-in and can't be disabled.
</Info>
