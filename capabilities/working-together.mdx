...
Teammates can collaborate and work together in one of two ways: they can `Delegate Task` to each other, or they can `Notify Teammate` to let others know about an event.

<Note>
To work together, you need to turn on the corresponding [Skill](./skills) in your Teammate's Profile page. They are OFF by default.
</Note>
