...
<Note>
Rules must be triggered by an _event_. This contrasts with a [Handbook](/capabilities/handbook), which is a static source of information that can be consulted at any time. 
...
Generally speaking, teammates will be able to introspect the event details themselves, but you can also use the [Handbook](/capabilities/handbook) to provide more context.
