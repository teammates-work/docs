...
1. After you install the app, you should see a screen with a `Bot User OAuth Token`. Copy this value. It's likely 50+ characters long starting with "xoxb" or similar
1. If you didn't copy it, you can find it again from the `OAuth & Permissions` section in your app's configuration page
