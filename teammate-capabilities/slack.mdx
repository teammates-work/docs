...
1. In the [Teammates app](https://app.teammtes.work/teammtes), click on your Teammate's profile and then click `Chat in Slack`. This will display the manifest JSON custom made for your teammate.
